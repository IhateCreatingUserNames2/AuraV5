...
class BaseMemory(BaseModel):
    ...
    dynamic_salience_score: float = Field(0.5, ge=0.0, le=1.0)
    decay_rate: float = Field(0.01)

    # --- CORREÇÃO AQUI: O campo embedding precisa existir para receber o vetor do Qdrant ---
    embedding: Optional[List[float]] = None
    embedding_reference: Optional[str] = None

    outcome_value: float = Field(0.0, description="Outcome of the experience...")
    learning_value: float = Field(0.0, ge=0.0, le=1.0, description="How much was learned...")
